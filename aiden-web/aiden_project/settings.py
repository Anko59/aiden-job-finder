...
SECRET_KEY = "django-insecure-cdp@#1dd&0n8id848#%7kfnmt&y7n9nw_l&efe%l%7o_x0)#_g"
...
ROOT_URLCONF = "aiden_project.urls"
...
WSGI_APPLICATION = "aiden_project.wsgi.application"
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "aiden_app/static"),
]
...
AWS_S3_EXTERNAL_DOMAIN = os.getenv("EXTERNAL_DOMAIN", "http://minio.dev.localhost:9000")
